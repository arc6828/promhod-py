...
> ~~2. ควรระบุและขยายความ **Research Gap** (ช่องว่างของงานวิจัยเดิม) ให้ชัดเจนยิ่งขึ้น ว่าเพราะเหตุใดระบบเดิมที่เ�การประยุกต์ใช้เครื่องมือควบคุมการทำงานแบบอัตโนมัติ (Workflow Orchestrator) ได้รับความสนใจในการบริหารจัดการข้อมูลขนาดใหญ่ โดยงานของ Deelman และคณะ (2015) เสนอสถาปัตยกรรมระบบบริหารจัดการลำดับงานอัตโนมัติ (Workflow Management System: WMS) สำหรับงานวิจัยเชิงวิทยาศาสตร์ เพื่อช่วยเพิ่มประสิทธิภาพในการจัดการและประมวลผลข้อมูลปริมาณมากอย่างมีระบบ��ูล และเพิ่มความครอบคลุมเพื่อสร้างระบบเตือนภัยล่วงหน้าที่ตอบสนองต่อเหตุการณ์ได้ทันท่วงที (Revilla-Romero et al., 2015)
...
การประยุกต์ใช้เครื่องมือควบคุมการทำงานแบบอัตโนมัติ (Workflow Orchestrator) ได้รับความสนใจในการบริหารจัดการข้อมูลขนาดใหญ่ โดยงานของ Deelman และคณะ (2015) เสนอสถาปัตยกรรมระบบบริหารจัดการลำดับงานอัตโนมัติ (Workflow Management ### 4.4. สารสนเทศเชิงพื้นที่จากข้อมูลสกัด (Visualization)
